  ...
  return (
    <section id="community" className="py-20">
      <div className="container mx-auto px-4">
        <h2 className="neon-text pink text-center text-4xl mb-12 font-cyber">Join The Community</h2>
        
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          <div className="card-3d-container">
            <div className="neo-card neo-card-blue card-3d p-6">
              <h3 className="neon-text cyan text-xl mb-4 font-cyber">Discord Server</h3>
              <p className="mb-4 font-body">Join our thriving community of over 1,000 members. Share your creations, discuss the latest games, and get notified when I go live.</p>
          ...
          <div className="card-3d-container">
            <div className="neo-card neo-card-pink card-3d p-6">
              <h3 className="neon-text pink text-xl mb-4 font-cyber">Social Media</h3>
              <p className="mb-4 font-body">Follow me on social media for updates, behind-the-scenes content, and more ways to connect with the community.</p>
          ...
          <div className="card-3d-container">
            <div className="neo-card neo-card-lime card-3d p-6">
              <h3 className="neon-text lime text-xl mb-4 font-cyber">Support The Stream</h3>
              <p className="mb-4 font-body">Your support helps me create better content and improve the stream quality. Consider donating if you enjoy the content!</p>
